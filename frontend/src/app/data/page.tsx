/**
 * Data Workspace — Matches Intellectual Canvas floating bar pattern.
 */
"use client";
...
const DATA_CHIPS = ["Analyze this CSV", "Visualize trends", "Predict next quarter", "Clean this dataset"];
        ...
        <section className="space-y-12 mb-24">
          {messages.length === 0 && (
            <div className="py-24 flex flex-col items-center">
              <span className="material-symbols-outlined text-6xl mb-6 text-slate-300">analytics</span>
              ...
              <p className="text-center max-w-md text-secondary font-body">
                Analyze, visualize, and interpret complex datasets. The Curator will help you uncover hidden patterns and provide statistical rigor.
              </p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="relative">
            <div className="bg-surface-container-lowest shadow-2xl shadow-slate-200/50 rounded-2xl flex items-center px-6 py-4 gap-4 ring-1 ring-slate-100 transition-all focus-within:ring-primary/20">
              ...
              <input 
                ...
                placeholder="Upload data or ask for analysis..."
                value={input} 
