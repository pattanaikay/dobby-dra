...
const DATA_CHIPS = ["Summarize this dataset", "Find correlations", "Generate a chart", "Statistical analysis"];
        ...
        <section className="space-y-12 mb-24">
          {messages.length === 0 && (
            <div className="py-24 flex flex-col items-center">
              <span className="material-symbols-outlined text-6xl mb-6" style={{ color: "var(--outline-variant)" }}>bar_chart</span>
              ...
              <p className="text-center max-w-md" style={{ color: "var(--secondary)" }}>
                Analyze datasets, find patterns, and generate visualizations with AI-powered insights.
              </p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div className="bg-white shadow-2xl shadow-slate-200/50 rounded-2xl flex items-center px-6 py-4 gap-4 ring-1 ring-slate-100 transition-all focus-within:ring-[var(--primary)]/20">
              ...
              <input type="text" className="flex-1 bg-transparent border-none focus:ring-0 focus:outline-none text-[0.9375rem] placeholder:text-slate-400"
                style={{ fontFamily: "var(--font-body)" }} placeholder="Ask about your data..."
